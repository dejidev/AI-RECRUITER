...
import { BarChart3, Clock, FileText, Mail, Search, Settings, Users } from "lucide-react"
  ...
  return (
    <div className="flex min-h-screen flex-col">
      ...
      <footer className="border-t bg-white">
        <div className="container flex flex-col gap-2 py-4 text-center md:flex-row md:justify-between md:py-6 px-4 md:px-6">

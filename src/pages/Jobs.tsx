import { ChevronDown, Edit2, Home, Plus, Search, SlidersHorizontal, Trash, UserCog } from "lucide-react"
        ...
        <div className="px-4 bg-gray-50 min-h-screen">
            ...
            <section className="mt-16 ">
                ...
                <div className="bg-white p-4" >
                    <h1 className="flex items-center  font-semibold text-gray-800 text-xl ">Jobs</h1>
                        ...
                        <div className="flex gap-6 text-sm font-semibold">
                            {["Open", "Closed", "Draft"].map((label) => (
                                <span
                                    ...
                                    className={`cursor-pointer whitespace-nowrap ${statusFilter === label ? "text-[#1370C8]" : "text-gray-600"
                                        }`}
                                >
                                    {label}
                                </span>
                                    ...
                                    <tr>
                                        <td colSpan={5} className="py-10">
                                            <div className="flex flex-col items-center justify-center text-gray-500 my-8">
                                                ...
                                                />
                                                <p className="text-base text-gray-500 ">No jobs match this filter.</p>
                                            </div>
                                        </td>
                                    </tr>
                                )}

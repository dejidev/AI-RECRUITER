              ...
              <div className="flex flex-col justify-center space-y-4">
                <div className="space-y-2">
                  ...
                  <p className="max-w-[600px] text-gray-500 md:text-xl">
                    Reduce recruitment cycle time by up to 3x and lower hiring
                    costs by up to 50% through automation and AI-driven
                    candidate ranking.
                  </p>
                </div>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Our AI-powered platform streamlines your recruitment process
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 mt-8">
              <Card>
                ...
                <CardContent>
                  <CardDescription>
                    Automatically extract and normalize candidate information
                    using NLP-powered parsers.
                  </CardDescription>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <CardDescription>
                    Match candidate profiles to job descriptions by identifying
              ...
              <Card>
                ...
                <CardContent>
                  <CardDescription>
                    Compute suitability scores based on role-specific criteria
              ...
              <Card>
                ...
                <CardContent>
                  <CardDescription>
                    Generate and send AI-crafted, personalized feedback emails
                    to each applicant.
                  </CardDescription>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <CardDescription>
                    Interactive analytics dashboard with augmented insights and
              ...
              <Card>
                ...
                <CardContent>
                  <CardDescription>
                    Ensure fairness with built-in bias-mitigation techniques and
                    regular audits.
                  </CardDescription>
                </CardContent>
              </Card>
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Our platform simplifies your recruitment workflow in four easy
                  steps.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4 mt-12">
              <div className="flex flex-col items-center text-center">
                ...
                <p className="mt-2 text-gray-500">
                  Bulk upload resumes or connect to your ATS for seamless
                  integration.
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                ...
                <p className="mt-2 text-gray-500">
                  Our AI analyzes and matches candidates to your job
                  descriptions.
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                ...
                <p className="mt-2 text-gray-500">
                  Get ranked candidate lists with detailed match scores and
                  insights.
                </p>
              </div>
              <div className="flex flex-col items-center text-center">
                ...
                <p className="mt-2 text-gray-500">
                  Send personalized feedback to all candidates with one click.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4 md:px-6">
            ...
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-8 md:grid-cols-3 mt-12">
              <div className="flex flex-col items-center text-center p-6 bg-white rounded-lg shadow-sm border">
                ...
                <p className="mt-2 text-gray-500">
                  Reduce your recruitment cycle time by up to threefold through
                  automation.
                </p>
              </div>
              <div className="flex flex-col items-center text-center p-6 bg-white rounded-lg shadow-sm border">
                ...
                <p className="mt-2 text-gray-500">
                  Lower hiring costs significantly with AI-driven candidate
                  ranking.
                </p>
              </div>
              <div className="flex flex-col items-center text-center p-6 bg-white rounded-lg shadow-sm border">
                ...
                <p className="mt-2 text-gray-500">
                  Improve candidate quality and reduce mis-hires with
          ...
          <div className="container mx-auto px-4 md:px-6">
            <div className="flex flex-col items-center justify-center space-y-4 text-center">
              <div className="space-y-2">
                ...
                <p className="max-w-[900px] text-gray-500 md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
                  Hear from companies that have transformed their recruitment
                  process.
                </p>
              </div>
            </div>
            <div className="mx-auto grid max-w-5xl grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3 mt-12">
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-500">
                    "We've reduced our time-to-hire by 70% and improved our
                    quality of hires significantly. The personalized feedback
                    feature has also greatly enhanced our candidate experience."
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-500">
                    "The AI Recruiter platform has transformed how we handle
                    high-volume hiring. We're now able to process thousands of
                    applications efficiently while maintaining a personal
                    touch."
                  </p>
                </CardContent>
              </Card>
              <Card>
                ...
                <CardContent>
                  <p className="text-gray-500">
                    "As a growing startup, we needed a solution that could scale
                    with us. AI Recruiter has not only saved us time and money
                    but has helped us build a diverse and talented team."
                  </p>
                </CardContent>
              </Card>
            </div>
